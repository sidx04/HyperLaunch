          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            ...
            <div className="grid grid-cols-1 gap-6 mt-6">
              <div className="bg-[#232323] w-full p-6 md:p-10 rounded-[30px] mt-6 space-y-4">
                ...
                <div className="flex flex-col">
                  <div className="text-[#83f8ff] font-semibold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          <div className="leading-[20px] inline-block p-3 bg-[#232323] rounded-xl overflow-hidden space-y-6">
            ...
            <p className="text-[#7d7d7d]">
              Mint Authority allows the token developer to mint more supply of
              your token.
            </p>
          ...
          <div className="leading-[20px] inline-block p-3 bg-[#232323] rounded-xl overflow-hidden space-y-6">
            ...
            <p className="text-[#7d7d7d]">
              Freeze Authority allows token developer to freeze token accounts
              of holders.
            </p>
          ...
          <div className="leading-[20px] inline-block p-3 bg-[#232323] rounded-xl overflow-hidden space-y-6">
            ...
            <p className="text-[#7d7d7d]">
              Update Authority allows token developer to update the token
              metadata.
            </p>
            <div className="justify-between items-center flex">
              <p className="font-semibold">+0.05 SOL</p>
