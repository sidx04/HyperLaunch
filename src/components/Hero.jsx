  ...
  return (
    <div className="sm:pt-10 bg-black text-white relative">
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center justify-center h-screen">
          <div className="relative flex flex-col lg:flex-row items-center justify-center lg:gap-4 w-full">
            <div className="relative order-1 mb-8 lg:mb-0">
              <h1
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 text-white font-bold font-['Roboto'] uppercase 
            ...
            <div
              className=" flex-col hidden pt-2 md:block lg:items-start text-center max-w-xs z-20 
          ...
          <div className=" flex-col block md:hidden items-center lg:items-start text-center max-w-xs z-20">
            <p className="mt-10 text-sm md:text-base text-white mb-6">
              Launch Tokens & Create Liquidity Pools effortlessly!
              <br />
              No coding required.
            </p>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pb-24 text-center">
        <h2 className="text-white font-semibold uppercase text-3xl sm:text-4xl tracking-wider">
          Our Numbers
        </h2>

        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 gap-8 mt-10">
          {[
            ...
            <div
              key={index}
              className="flex flex-col items-center px-4 py-4 border border-[#5c5c5c] rounded-xl"
            >
              <p className="text-[1rem] sm:text-xl font-semibold">
                {stat.title}
              </p>
